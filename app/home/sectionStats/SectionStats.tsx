        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {items.map((item, idx) => (
            <TiltCard key={idx} maxTiltDeg={12} scale={1.03} glare>
              <div
                className="
                  flex flex-col px-6 py-8 justify-center sm:text-start text-center gap-1 flex-1
                  border-b-[10px] border-brand-secondary-500 bg-brand-secondary-50 rounded-sm min-w-[232px]

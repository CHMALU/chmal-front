...
export function SectionCTA({ data, buttonSettings }: SectionCTAProps) {
  ...
  return (
    <section className="py-8">
      <Container>
        <div className="relative flex items-center justify-center w-full min-h-[356px] rounded-2xl overflow-hidden">
          ...
          <div className="dark-selection px-4 py-12  z-10 flex w-[816px] flex-col justify-center items-center gap-12 ">
            <Header
              noPaddingY
              textWhite
              title={sectionTitle}

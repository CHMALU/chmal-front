      ...
      <div className="border-t-4 border-brand-primary-500 bg-brand-secondary-500">
        <Container>
          <ul className="flex justify-between items-center">
            <li className="">
              <Link href={defaultItems[0].href}>
                <div className="flex py-4 px-2 justify-center ag-right-aligned-cell gap-2">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
            ...
            {navItems.slice(1, -1).map((item) => (
              <li key={item.href} className="px-2 py-4">
                <Link href={item.href}>
